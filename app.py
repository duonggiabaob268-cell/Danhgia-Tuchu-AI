...
if st.session_state.page == 1:
  ...
  with col_center2:
    st.markdown("### 📋 Bước 1: Nhập thông tin học sinh")
    ...
    st.markdown("---")
    st.markdown("### ⚙️ Bước 2: Nhập các chỉ số hành vi thực nghiệm")

    c_blind = st.slider(
        "1. Tỷ lệ sao chép mù quáng (C_blind):",
        min_value=0.0,
        max_value=1.0,
        value=st.session_state.get("c_blind", 0.40),
        step=0.01,
        help=(
    ...
    f_off = st.slider(
        ...
        min_value=0.0,
        max_value=1.0,
        value=st.session_state.get("f_off", 0.60),
        step=0.01,
    ...
    t_off = st.slider(
        ...
        min_value=0.0,
        max_value=1.0,
        value=st.session_state.get("t_off", 0.17),
        step=0.01,
        help=(
